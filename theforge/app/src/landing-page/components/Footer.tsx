    ...
    <div className='mx-auto mt-6 max-w-7xl px-6 lg:px-8 dark:bg-boxdark-2'>
      ...
      >
        ...
        <div className='flex items-start justify-end mt-10 gap-20'>
          <div>
            <h3 className='text-sm font-semibold leading-6 text-gray-900 dark:text-white'>Titties-App</h3>
          ...
          <div>
            <h3 className='text-sm font-semibold leading-6 text-gray-900 dark:text-white'>Built by cojovi.com</h3>
            <ul role='list' className='mt-6 space-y-4'>

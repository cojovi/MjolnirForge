      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <div id='pricing' className='mx-auto max-w-4xl text-center'>
          <h2 className='mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl dark:text-white'>
            CMAC Roofing <span className='text-yellow-500'>Locations</span>
          </h2>
        </div>
        <p className='mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600 dark:text-white'>
          Location specific framework to give our area presidents the freedom to create the best workflows in the nation 
          CMAC Roofing{' '}
          <span className='px-2 py-1 bg-gray-100 rounded-md text-gray-500'>Revolutionizing the Industry</span>
        </p>
